...
class Label(Control):
    ...
    def __init__(self, name: str,position: Tuple[float, float],text: str, font_size= None,font_italic=None,
                 align:int = LEFT):
        "A basic label."
        super().__init__(name,Control.LABEL,font_name= None,font_size=font_size,font_italic=font_italic,text=text)
